<template>
  <li class="mb-7">
      <router-link to="/jobs/results/1" class="mx-auto block rounded border border-solid 
        border-brand-gray-2 bg-white hover:shadow-gray">
          ...
          <div>
            ...
            <div>
              <ul class="list-disc pl-8">
                <li>Bacelor's degree or equivalent practical experience.</li>
                <li>5 years of experience in program management.</li>
                <li>
                  Experience analyzing data through querying database (e.g.,SQL) using spreadsheet software,
